"""
Part of the "How to Build a Model Using AtomWorks" tutorial.
...
# NOTE: import matches the tutorial text and assumes you run this script from the
# directory containing transforms.py. (The PR used the absolute package path
# docs.how_to_build_a_model.scripts.transforms, which only resolves when run as a
# module from the repo root.) Keep this consistent with train.py.
